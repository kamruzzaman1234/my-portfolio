        ...
        <div className="pt-20">
            <div className="max-w-5xl px-10 lg:px-0 w-full mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div className="flex flex-col gap-3 px-6 py-6 shadow-lg border-b-8 border-cyan-500">
                        <div className="flex justify-between items-center">
                            <h3 className={`${cinzel_decorative.className}
                            text-lg  font-bold text-cyan-500`}>Bachelor of Science in CSE</h3>
                     ...
                     <div className="flex flex-col gap-3 px-6 py-6 shadow-lg border-b-8 border-cyan-500">
                        <div className="flex justify-between items-center">
                            <h3 className={`${cinzel_decorative.className}
                            text-lg text-cyan-500 font-bold`}>Diploma Engineering</h3>
                            <h3 className={`${cinzel_decorative.className} text-sm
